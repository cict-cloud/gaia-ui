...
BaseDrawer               ← right-side drawer with composed title slot (standalone)
BaseModal                ← modal with composed title slot (standalone)
ConfirmModal             ← destructive-action confirmation modal (standalone)
